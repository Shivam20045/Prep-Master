...
export const LOGOS = [
  ...
  { src: "/accenture.svg", alt: "Accenture" },
];
...
// CHANGED: was amber/dark (border-amber-400/30, text-stone-500, bg-white/x...).
// Re-themed to the violet/light palette so it matches the rest of the redesign.
export const SLOTS = [
  {
    label: "Mon 10:00 AM",
    cls: "border-violet-200 text-violet-700 bg-violet-50",
  },
  { label: "Mon 2:00 PM", cls: "border-slate-200 text-slate-400" },
  {
    label: "Tue 11:00 AM",
    cls: "border-violet-200 text-violet-700 bg-violet-50",
  },
...
// Appointment Card Data — unchanged, belongs to dashboard/booking pages,
// not the redesigned landing page. Revisit if you redesign those pages too.
...
// Feedback Modal — unchanged, same reasoning as above
...
// Booking Page — unchanged, same reasoning as above
